...
Devise.setup do |config|
  ...
  # Mon code
  config.omniauth :facebook, ENV["APP_ID"], ENV["APP_SECRET"], token_params: { parse: :json }, scope: 'email, first_name, last_name, phone, gender, image', info_fields: 'email, first_name, last_name, phone, gender, image', image_size: 'square', secure_image_url: true, client_options: {
